                ...
                <div class="grid lg:grid-cols-2 min-h-[350px]">
                    ...
                    <div class="relative hidden lg:flex bg-gradient-to-br from-indigo-600/90 via-purple-600/90 to-indigo-800/90">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center text-white animate-slide-up">
                                ...
                                <h3 class="mb-4 text-3xl font-bold">Selamat Datang, Admin!</h3>
                                <p class="max-w-sm mx-auto leading-relaxed text-indigo-100 text-md">
                                    Kelola data peserta dan presensi acara di sini
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col justify-center p-4 lg:p-6">
                        ...
                        <div class="mb-6 text-center">
                            ...
                            <p class="font-sans text-sm font-light text-gray-500">Silakan login untuk mengakses sistem presensi acara</p>
                        </div>
